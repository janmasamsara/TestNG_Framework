...
public class registerwebpages {
	...
	public WebElement mobile_no;
	 ...
	 @FindBy(how=How.XPATH,using="/html/body/header/div/div/div/div[2]/div/ul/li[5]/a")
	 public WebElement delete_account;
	 @FindBy(how=How.XPATH,using=("//b[contains(text(),\"Account Deleted!\")]"))
	 public WebElement acc_delmsg;
	 @FindBy(how=How.XPATH,using=("//a[contains(text(),\"Continue\")]"))
	 public WebElement del_continue;
